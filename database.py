...
WEIGHTS = {
    ...
    "LW":  dict(stamina=5,speed=12,jump=3,shooting=10,passing=8,dribbling=12,tackling=3,heading=3,positioning=8,setpiece=5,mental=5,confidence=5,leadership=5,concentration=8),
    "RW":  dict(stamina=5,speed=12,jump=3,shooting=10,passing=8,dribbling=12,tackling=3,heading=3,positioning=8,setpiece=5,mental=5,confidence=5,leadership=5,concentration=8),
    "CF":  dict(stamina=5,speed=8,jump=8,shooting=12,passing=10,dribbling=10,tackling=2,heading=8,positioning=10,setpiece=5,mental=5,confidence=5,leadership=3,concentration=8),
    "ST":  dict(stamina=5,speed=10,jump=10,shooting=15,passing=3,dribbling=5,tackling=1,heading=12,positioning=12,setpiece=5,mental=5,confidence=5,leadership=3,concentration=8),
}

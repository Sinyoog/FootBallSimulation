...
# ─── 리그/팀 데이터 ───────────────────────────────────────────
LEAGUE_DATA = {
    '보스니아 헤르체고비나': {1: ('보스니아 프리미어리그', ['FK 사라예보', 'FK 젤레즈니차르', 'HŠK 즈린스키 모스타르', 'FK 보라츠 바냐루카', 'NK 시로키 브리예그', 'FK 벨레주 모스타르', 'HŠK 포스셰', 'FK 슬로가 도보이']), 2: ('보스니아 퍼스트 리그', ['FK 슬로보다 투즐라', 'NK 첼리크 제니차', 'FK 루다르 프리예도르', 'FK 레오타르', 'BFK 시민 한', 'FK 라드니크 비옐리나', 'NK 토미슬라브', 'FK 고라주데']), 3: ('보스니아 세컨드 리그', ['NK 크리바야', 'FK 파마스', 'FK 보라츠 샤마츠', 'NK 브라트스트보', 'FK 포드린예', 'FK 일리자', 'NK 비테즈', 'FK 루다르 카칸'])},
    ...
    '튀르키예': {1: ('쉬페르리그', ['갈라타사라이', '페네르바체', '베식타스', '트라브존스포르', '바샥셰히르', '아다나 데미르스포르', '안탈리아스포르', '카슴파샤']), 2: ('TFF 1. 리그', ['앙카라귀쥐', '파티흐 카라귐뤼크', '이스탄불스포르', '펜디크스포르', '괴즈테페', '에유프스포르', '사카리아스포르', '코자엘리스포르']), 3: ('TFF 2. 리그', ['부르사스포르', '알타이', '기레순스포르', '데니즐리스포르', '카르시야카', '바투만', '반스포르', '메르신'])},
    ...
    '북한': {1: ('최고급축구련맹전', ['4.25체육단', '압록강체육단', '평양체육단', '기관차체육단', '려명체육단', '소백수체육단', '선봉체육단', '월미도체육단']), 2: ('1부류축구련맹전', ['체비에체육단', '자강도체육단', '함경북도체육단', '황해남도체육단', '평안북도체육단', '양강도체육단', '4.25 B', '평양 B']), 3: ('2부류축구련맹전', ['압록강 B', '기관차 B', '원산체육단', '청진체육단', '함흥체육단', '신의주체육단', '남포체육단', '강계체육단'])},
    ...
    '리비아': {1: ('리비안 프리미어리그', ['알 아흘리 트리폴리', '알 이티하드 트리폴리', '알 아흘리 벵가지', '알 나스르 벵가지', '알 수웨흘리', '알 메디나', '알 아크달', '올림픽 AZ']), 2: ('리비안 퍼스트 디비전', ['알 자지라', '알 마디나', '알 타하디', '알 와다', '알 사와에크', '알 샤라라', '알 오라바', '알 다르네스']), 3: ('세컨드 디비전', ['알 안사르', '알 키파', '알 나즈마', '알 슈알라', '알 테하드', '알 마즈드', '알 히랄', '알 아말'])},
    '니제르': {1: ('니제르 프리미어리그', ['AS GNN', 'AS 도안', 'US 가르드 나시오날', 'AS포니', '사헬 SC', '올림픽 FC', '니제르디아', 'ASN 니제르렉']), 2: ('두지엠 디비전', ['AS 폴리스', '장도르므리', 'JS 타우아', '마라디 FC', '진더 유나이티드', '디파 스포르', '아가데즈 FC', '틸라베리 스포르']), 3: ('트루아지엠 디비전', ['타우아 시티', '도소 FC', '마라디 스타', '아가데즈 유나이티드', '사헬 유니온', '가르드 스포르', '니제르 유나이티드', '디파 시티'])},
    '감비아': {1: ('GFA 리그 퍼스트 디비전', ['리얼 드 반줄', '포춘 FC', '가방 FC', '월리단 FC', '브리카마 유나이티드', '호크스 FC', '마리모 FC', '샘거 FC']), 2: ('세컨드 디비전', ['봄바다 FC', 'PSV 웰링가라', 'BK 밀란', '라트리쿠NDA', '기아나 FC', '자라 FC', '그레이터 반줄', '팀 리노']), 3: ('서드 디비전', ['반줄 유나이티드', '세레쿠NDA', '브리카마 스타', '가방 유니온', '샘거 스타', '호크스 유니온', '리얼 반줄 B', '포춘 스타'])},
    '수단': {1: ('수단 프리미어리그', ['알 힐랄 옴두르만', '알 메레이흐', '하이라는 알 아랍', '알 아흘리 셰ندی', '알 힐랄 알 우바이이드', '알 아흘리 카르툼', '알 아흘리 메로웨', '코르도판']), 2: ('수단 퍼스트 디비전', ['알 투티', '알 와디', '알 메레이흐 알 파셰르', '알 힐랄 카달리', '알 아흘리 아트바라', '알 힐랄 파셰르', '알 코프라', '알 수크']), 3: ('로컬 리그', ['옴두르만 스타', '카르툼 유나이티드', '바리 FC', '포트수단 스포르', '카살라 FC', '와드 메다니', '엘 오베이드', '나할'])},
    '토고': {1: ('내셔널 챔피언십', ['AS코 페아', 'ASC 카라', '디나미크 토골레', '고오호수', 'AS OTR', '엔텐테 II', '셈마시 FC', '에스포아 FC']), 2: ('두지엠 디비전', ['아가자 LOME', '마란나타 FC', '이포제 FC', '코토코 FC', '안젤 FC', 'foumban FC', '골프 FC', '아라비아 FC']), 3: ('트루아지엠 디비전', ['로메 시티', '카라 유나이티드', '페아 스타', '오티 FC', '모노 스포르', '클럽 디나미크', '토고 유니온', '에스포아 B'])},
    '콩고 민주 공화국': {1: ('리나풋 리그 1', ['TP 마젬베', 'AS 비타 클럽', 'FC 생엘루아 루포포', 'DC 모테마 펨베', 'AS 마니에마 유니온', 'JS 킨샤사', '스마 발랑드', '루방바시 스포르']), 2: ('리나풋 리그 2', ['르네상스 두 콩고', 'AC 우캉가', 'RC 킨샤사', 'AS 도앙', 'FC 생크 시티', 'US 트쉬인쿠', 'OC 무앙가이', 'AS 니아키']), 3: ('프로방스 로컬 리그', ['FC 마케사', 'AS 방투', 'FC 키부', 'JS 리카시', 'CS 카탕가', 'FC 킬로', 'AS 코발트', 'FC 오카피'])},
    '부르키나 파소': {1: ('부르키나베 프리미어 리그', ['ASFA 옌넹가', 'RC 보보 디울라소', '에투알 필랑트', '마제스틱 FC', '살리타스 FC', 'AS 도안', 'AS SONABEL', 'RAHIMO FC']), 2: ('두지엠 디비전', ['USFA 와가두구', 'ASEC 쿠두구', 'RC 카디오고', 'AS 폴리스', '산토스 FC', 'US 프리앙', 'FC 보보', 'AS 코스모스']), 3: ('트루아지엠 디비전', ['와가두구 시티', '볼투르 FC', '볼타 스포르', 'AS 구르마', '야텡가 FC', '지니 아카데미', '보보 유나이티드', '사바나 FC'])},
    '모잠비크': {1: ('모잠비콜라', ['페로비아루 마푸투', '코스타 두 솔', '블랙 불스', 'UD 스롱구에', '페로비아루 베이라', '페로비아루 나풀라', '리가 무술마나', '에스투디안테스']), 2: ('디비장 드 온라', ['디스포르티바 마푸투', '텍사프리카', '페로비아루 켈리마네', '마샤케네', '빌랑쿨로 FC', '이냠바네 FC', '가자 유나이티드', '칭가노']), 3: ('프로방스 챔피언십', ['마푸투 시티', '베이라 유나이티드', '나풀라 FC', '치모이오 스포르', '켈리마네 유니온', '솔 도 솔', '아틀레티코 무술마나', '펨바 FC'])},
    '적도 기니': {1: ('리메라 디비시온', ['아코낭기 FC', '데포르티보 몽고모', '레알 마라보', '소니 엘라 낭게', '레오네스 베게타노스', '드래곤 FC', '카노 스포르', '데포르티보 니에팡']), 2: ('세군다 디비시온', ['아틀레티코 말라보', '산 페드로 FC', '유니온 베게가', '몽고모 시티', '바타 유나이티드', '루바 FC', '에비네용 스포르', '음비니 FC']), 3: ('리가 디스트리탈', ['에비네용 유나이티드', '코스코 FC', '레알 세이바', '아틀레티코 바타', '산 판타레온', '낭게 FC', '몽고모 유나이티드', '말라보 킹스'])},
    '코모로': {1: ('코모로 프리미어리그', ['FC 드 자니', '볼칸 클럽', 'US 즈림카니', '엘란 클럽', '엔카니 FC', 'Fomboni FC', '스타일 뉴', '아파체 클럽']), 2: ('디비전 2', ['응가지 클럽', '에투알 드 생트', 'FC 무아시', '자니 시티', '미치아미울리 스포르', '코모로 유나이티드', '음바치 FC', '이코니 유나이티드']), 3: ('디비전 3', ['사유스 스포르', '그랑드 코모로 FC', '도모니 스타', '앙주안 유나이티드', '모헬리 FC', '클럽 아프리카', '바우 스타', '체미 시티'])},
    '탄자니아': {1: ('탄자니아 프리미어리그', ['심바 SC', '야공 아프리카스', '아잠 FC', '싱기다 폰텐', 'KMC FC', 'Mtibwa 슈가', '카게라 슈가', '탄자니아 프 Prisons']), 2: ('챔피언십 리그', ['Pamba SC', 'Mbeya 시티', 'JKT 탄자니아', 'Biashara 유나이티드', '그린 워리어스', 'Transit 캠프', '음베야 Kwanza', '코스탈 유니온']), 3: ('퍼스트 디비전', ['도도마 시티', '이링가 유나이티드', '루부 스타즈', '아루샤 FC', '타보라 FC', '모로고로 유나이티드', '음트와라 스타', '키고마 시티'])},
    '시에라리온': {1: ('시에라리온 프리미어리그', ['보 레인저스', '마이티 블랙풀', '이스트엔드 라이온즈', 'FC 칼론', '다이아몬드 스타즈', '포츠 오소리티', '올드 에드워디안즈', '완보이즈']), 2: ('퍼스트 디비전', ['캄보 이글스', '바이 부레 워리어스', '센트럴 퍼레이드', '골라 퀸즈', '안티 오카스', '레알 레오네스', '프리타운 시티', '마케니 스타즈']), 3: ('디스트릭트 리그', ['케네마 스타즈', '보 유나이티드', '코이두 타운', '루사르 FC', '마라타 스타', '서던 이글스', '노던 유나이티드', '이스트엔드 B'])},
    '르완다': {1: ('르완다 프리미어리그', ['APR FC', '라욘 스포르', '키요부 스포르', 'AS 킬가리', '폴리스 FC', '무쿠라 빅토리', '에틴셀 FC', '가소기 유나이티드']), 2: ('세컨드 디비전', ['루치로 FC', '에투알 드 레스트', '부게세라 FC', '아미라쥬 FC', '고릴라 FC', '루와마가나 시티', '은양자 FC', '기요부 B']), 3: ('서드 디비전', ['키갈리 시티', '부타레 FC', '기세니 스타', '루바부 스포르', '무상제 유나이티드', '르완다 유니온', '빅토리 스타', '라욘 B'])},
    '짐바브웨': {1: ('짐바브웨 프리미어리그', ['FC 플래티넘', '다이너모스 FC', '하이랜더스 FC', '카프스 유나이티드', '치킨 인 FC', '응게지 플래티넘', '마니카 다이아몬드', '불라와요 치프스']), 2: ('디비전 1', ['블랙 라이노스', '하라레 시티', '하르츠 FC', '텐락스 FC', '와하와하 FC', '불라와요 시티', '줄루 FC', '그린 퓨얼']), 3: ('디비전 2', ['미들랜드 스타즈', '마쇼날랜드 FC', '카리바 스타', '무타레 시티', '플래티넘 B', '다이너모스 B', '하이랜더스 B', '하라레 유나이티드'])},
    '콩고 공화국': {1: ('콩고 리그 1', ['오토호 도오이시', '디아블 느와르', 'AC 레오파드', 'CARA 브라자빌', 'JS 탈랑가이', '에투알 두 콩고', 'FC 콘도르', 'V클럽 모캉다']), 2: ('콩고 리그 2', ['아스토 카이요', 'AS 퐁투아즈', '인터클럽', '니아키 FC', 'AS 체미노', '브라자빌 시티', '탈랑가이 B', '레오파드 B']), 3: ('지역 디비전', ['포앵트누아르 스포르', '돌리지 유나이티드', '오요 스타', '오방도 FC', '카라 B', '에투알 B', '디아블 B', '콩고 유니온'])},
    '중앙아프리카공화국': {1: ('방기 리그 1', ['AS 템페트 모카프', 'DFC8', '레알 코보니', '올림픽 리얼', 'ASS 톡라프', '카스트로 FC', 'SICA 스포츠', '앙주 드 파티마']), 2: ('방기 리그 2', ['레오파드 드 발리', 'AS 소디암', '뱅구이 시티', '모카프 B', '코보니 B', '코스모스 FC', 'US 방기', '레알 스타']), 3: ('디스트릭트 리그', ['발리 유나이티드', '파티마 B', 'DFC B', '톡라프 B', '중앙아프리카 유니온', '사바나 스타', '카스트로 B', 'SICA B'])},
    '라이베리아': {1: ('라이베리아 퍼스트 디비전', ['LPRC 오일러즈', '바라크 유스 킹스', 'LISCR FC', '몬로비아 클럽', '닌바 콰도', '왓랑가 FC', '헤븐 일레븐', '인빈서블 일레븐']), 2: ('세컨드 디비전', ['토니 FC', '주니어 프로', 'NPA 앵커스', '가르드네르스빌', '닌바 유나이티드', '머스크 FC', '샌디 FC', '라이베리아 시티']), 3: ('서드 디비전', ['몬로비아 스타', '바라크 B', '오일러즈 B', 'LISCR B', '콰도 B', '주니어 스타', '앵커스 B', '헤븐 B'])},
    '부룬디': {1: ('부룬디 프리미어리그', ['비탈오 FC', '르 메사제르 르고지', '부몽고 FCO', '무스가티 FC', '플람보 두 센터', '아이글 노아', '올림픽 스타', '인터 스타']), 2: ('리가 A2', ['루몽게 스타', '부줌부라 시티', '르고지 FC', '카얀자 유나이티드', '은고지 시티', '기테가 FC', '비탈오 B', '인터 B']), 3: ('리가 A3', ['부줌부라 스타', '메사제르 B', '플람보 B', '아이글 B', '부몽고 B', '카얀자 B', '기테가 스타', '부룬디 유니온'])},
    '에티오피아': {1: ('에티오피아 프리미어리그', ['세인트 조지 SC', '에티오피아 커피', '파실 케네마', '바히르 다르 시티', '하와사 시티', '하다마 시티', '디레 다와 시티', '메켈레 70']), 2: ('에티오피아 하이어리그', ['웰왈로 아디그라트', '아다마 시티', '짐마 아바 지파르', '월키테 시티', '세베타 시티', '하디야 호사나', '시다마 커피', '아르바 민치']), 3: ('내셔널리그', ['디스포르티바 에티오피아', '커피 B', '세인트조지 B', '파실 B', '바히르 다르 B', '하와사 B', '디레다와 B', '짐마 B'])},
    '레소토': {1: ('레소토 프리미어리그', ['마틀라마 FC', '반투 FC', 'LCS FC', 'LMPS FC', '리올리 FC', 'LDF FC', '리포포 FC', '마추냐네 FC']), 2: ('A 디비전', ['리키라 FC', '마주에나 FC', '세포솅 FC', '리놀레 FC', '리틀 풋 FC', '반투 B', '마틀라마 B', 'LCS B']), 3: ('B 디비전', ['마세루 시티', '테야테야넹 FC', '레리베 스타', '마페텡 유나이티드', '모할레스 호크', 'LDF B', 'LMPS B', '리올리 B'])},
    '보츠와나': {1: ('보츠와나 프리미어리그', ['타운십 롤러즈', '가보로네 유나이티드', '조와넹 갤럭시', 'Orapa 유나이티드', '보츠와나 디펜스', '수아 플래밍고스', '시큐리티 시스템스', '엘레븐 엔젤스']), 2: ('퍼스트 디비전', ['모고디차네 파이터스', '노트와네 FC', '프란시스타운 시티', '익스텐션 건너즈', '모추디 센터', '마운 유나이티드', 'BR 하이랜더스', '경찰 XI']), 3: ('디비전 1', ['가보로네 스타', '롤러즈 B', '갤럭시 B', '오라파 B', '파이터스 B', '디펜스 B', '노트와네 B', '프란시스타운 B'])},
    '에스와티니': {1: ('에스와티니 프리미어리그', ['음바바네 스왈로즈', '로얄 레오파드', '음바바네 하이랜더스', '그린 맘바', '영 버팔로스', '만지니 원더러스', '모네니 파이럿츠', '일레븐 멘']), 2: ('내셔널 퍼스트 디비전', ['만지니 씨 드롭스', '블랙 마바', '레인저스 FC', '탐부티 FC', '밀레니엄 FC', '부쉬 벅스', '스왈로즈 B', '레오파드 B']), 3: ('수퍼리그', ['음바바네 시티', '만지니 스타', '피그스 피크 FC', '흘라티쿨루 FC', '하이랜더스 B', '맘바 B', '버팔로스 B', '원더러스 B'])},
    '모리셔스': {1: ('모리셔스 프리미어리그', ['Pamplemousses SC', 'GRSE 완더러스', 'AS 포트루이스', '세르클 드 요아킴', '로쉬 브룬 FC', '사반 클럽', '쁘띠 리비에르', 'AS 바코아스']), 2: ('퍼스트 디비전', ['포트루이스 블랙스', '요아킴 B', '엔텐테 부쉬', '리비에르 뒤 랑파르', '큐어파이프 스타', '바코아스 B', '사반 B', '포트루이스 B']), 3: ('세컨드 디비전', ['로즈힐 유나이티드', '바코아스 스타', '큐어파이프 스트라이커스', '로드리게스 유나이티드', '쁘띠 스타', '사반 유니온', '랑파르 스타', '완더러스 B'])},
    '차드': {1: ('차드 프리미어리그', ['에투알 뒤 차드', 'Elect-스포츠', '가젤 FC', '르네상스 FC', 'AS 코otonTchad', '투마이 FC', 'AS 디지아', '풀 아흘리']), 2: ('디비전 2', ['AS 폴리스', '장도르므리 차드', '은자메나 시티', '에투알 B', '가젤 B', '르네상스 B', '코톤 차드 B', '일렉트 B']), 3: ('로컬 챔피언십', ['문두 FC', '사르 FC', '아베셰 유나이티드', '봉고르 스포르', '폴리스 B', '은자메나 스타', '디지아 B', '차드 유니온'])},
    '상투메 프린시페': {1: ('상투메 챔피언십', ['UDRA', '스포르팅 프라야', '6 드 세TEMBRO', '알리앙사 FC', '포르투 가투', '데포르티보 과달루페', '인터 봄바림', '카이샹']), 2: ('세군다 디비시온', ['프라야 시티', '데포르티보 산타나', '네베스 FC', '트린다데 FC', '과달루페 B', 'UDRA B', '스포르팅 B', '알리앙사 B']), 3: ('디스트릭트 리그', ['산토 안토니오', '프린시페 스타', '과달루페 스타', '산타나 B', '네베스 B', '트린다데 B', '카이샹 B', '봄바림 B'])},
    '트리니다드 토바고': {1: ('TT 프리미어 풋볼 리그', ['디펜스 포스 FC', 'AC 포트오브스페인', '클럽 산도', '라 호르케타 レ인저스', 'W 코네션', '센트럴 FC', '포인트 포틴 시빅', '카레니 오센틱']), 2: ('내셔널 티어 2', ['모르반 칼레도니아', '산 후안 자블로테', '쿠바 유나이티드', '경찰 FC', '프리즌 서비스 FC', '디에고 마틴 세미프로', '토바고 유나이티드', '아리마 노스']), 3: ('지방 슈퍼리그', ['FC 산타 로사', '퀸즈 파크 CC', '기야구아야레 유나이티드', 'UWI FC', '시파리아 스포르팅', '마투라 리반', '발랑드 유나이티드', '샤구아나스 FC'])},
    '앤티가 바부다': {1: ('앤티가 바부다 프리미어리그', ['그린베이 호퍼스', 'GRENADES FC', '올드 로드 FC', 'SAP FC', '파햄 FC', '리버 플레이트 안티구아', '엠파이어 FC', '올 세인츠 유나이티드']), 2: ('퍼스트 디비전', ['윌키스 FC', '존 휴스 FC', '파햄 B', '그린베이 B', '올드 로드 B', 'SAP B', '호퍼스 유니온', '바부다 스타즈']), 3: ('세컨드 디비전', ['세인트존스 시티', '바부다 유나이티드', '앤티가 유니온', '엠파이어 B', '윌키스 B', '휴스 B', '올세인츠 B', '플레이트 B'])},
    '몬트세라트': {1: ('몬트세라트 챔피언십', ['플리머스 로버스', '살레 FC', '우드브릿지 FC', '해리스 유나이티드', '센트럴 스타즈', '루크 FC', '세인트존스 유나이티드', '데이비 힐 스포르']), 2: ('디비전 2', ['올드 로드 몬트세라트', '리틀 베이 FC', '플리머스 B', '살레 B', '우드브릿지 B', '해리스 B', '센트럴 B', '루크 B']), 3: ('디스트릭트 리그', ['로버스 스타즈', '살레 유니온', '우드브릿지 스타', '해리스 스타', '센트럴 유니온', '존스 B', '데이비 힐 B', '몬트세라트 유니온'])},
    '벨리즈': {1: ('벨리즈 프리미어리그', ['벨모판 밴디츠', '베르데스 FC', '산페드로 파이럿츠', '플라센시아 아세아노', 'Wagiya SC', '알티플라노 FC', '프로그레소 FC', '포트 벨리즈 FC']), 2: ('퍼스트 디비전', ['벨리즈 디펜스 포스', '카요 유나이티드', '오렌지 워크', '톨레도 스타즈', '코로살 FC', '밴디츠 B', '베르데스 B', '파이럿츠 B']), 3: ('지역 리저브 리그', ['벨모판 시티', '산페드로 스타', '오렌지 워크 스타', '코로살 스타', '톨레도 유나이티드', '플라센시아 B', '프로그레소 B', '디펜스 B'])},
    '앵귈라': {1: ('앵귈라 AFA 리그', ['로링 라이온즈', '독스 유나이티드', '어택커스 FC', '살사 FC', '업라이징 FC', '알리안스 FC', '다이아몬드 FC', '스파르탄스 FC']), 2: ('AFA 퍼스트 디비전', ['더 밸리 FC', '이스트엔드 유나이티드', '로링 라이온즈 B', '독스 B', '어택커스 B', '살사 B', '업라이징 B', '알리안스 B']), 3: ('AFA 챔피언십', ['밸리 스타즈', '이스트엔드 스타', '다이아몬드 B', '스파르탄스 B', '앵귈라 유니온', '로링 스타', '독스 스타', '어택커스 스타'])},
    '캄보디아': {1: ('캄보디아 프리미어리그', ['프놈펜 크라운', '프레아 칸 리치 스바이리엔', '비스카 FC', '나가월드 FC', '보에웅 케트 FC', '앙코르 타이거', 'Tiffy 아미', '키리봉 소크 센 체이']), 2: ('캄보디아 리그 2', ['내셔널 폴리스 FC', '프놈펜 크라운 B', '스바이리엔 B', '비스카 B', '나가월드 B', '보에웅 케트 B', '아시아 유로 유나이티드', '솔틸로 앙코르']), 3: ('프로방스 컵 리그', ['시엠립 FC', '바탐방 FC', '시아누크빌 FC', '캄포트 FC', '타케오 FC', '폴리스 B', '아미 B', '앙코르 유나이티드'])},
    '네팔': {1: ('마힌드라 A 디비전 리그', ['마낭 마르샹디 클럽', '네팔 경찰 클럽', '쓰리 스타 클럽', '네팔 군대 클럽', '마나스루 FC', '자왈라켈 유스', '산카타 클럽', '뉴 로드 팀']), 2: ('B 디비전 리그', ['프라티바 유스', '보이즈 유니온', '풀바리 유스', '마낭 B', '경찰 B', '쓰리스타 B', '군대 B', '자왈라켈 B']), 3: ('C 디비전 리그', ['카트만두 유나이티드', '포카라 스타즈', '랄릿푸르 FC', '박타푸르 FC', '산카타 B', 'NRT B', '보이즈 B', '네팔 유니온'])},
    '방글라데시': {1: ('방글라데시 프리미어리그', ['바슌드하라 킹스', '아바하니 리미티드 다카', '셰이크 자말', '모함메단 SC', '치타공 아바하니', '셰이크 러셀', '레이디스 클럽', '포티스 FC']), 2: ('방글라데시 챔피언십 리그', ['파키라풀 YMC', '다카 완더러스', 'Wari 클럽', '바슌드하라 B', '아바하니 B', '셰이크자말 B', '모함메단 B', '치타공 B']), 3: ('다카 리그 세컨드 티어', ['다카 시티 FC', '노펠 스포츠 클럽', '우타라 FC', '러셀 B', '포티스 B', '완더러스 B', 'YMC B', '방글라데시 유니온'])},
    '라오스': {1: ('라오 프리미어리그', ['영 엘리펀트 FC', '마스터 7 FC', '에즈라 FC', '비엔티안 FT', '루앙프라방 FC', '라오 군대 FC', '남타 유나이티드', '참파사크 FC']), 2: ('라오 리그 2', ['비엔티안 유나이티드', '참파사크 유나이티드', '영엘리펀트 B', '마스터7 B', '에즈라 B', '군대 B', '사반나케트 FC', '퐁살리 FC']), 3: ('프로방스 리그', ['루앙프라방 스타', '비엔티안 스타', '참파사크 스타', '남타 스타', '사반 유나이티드', '라오 유니온', '에즈라 스타', '엘리펀트 스타'])},
    '마카오': {1: ('마카오 1부 리그', ['차오 파크', '벤피카 드 마카오', '스포르팅 드 마카오', '몬테카를로', '룬록', '체 정', '항 사이', '마카오 경찰 축구단']), 2: ('마카오 2부 리그', ['알리안사 드 마카오', '개발 팀 마카오', '차오파크 B', '벤피카 B', '스포르팅 B', '몬테카를로 B', '룬록 B', '체정 B']), 3: ('마카오 3부 리그', ['마카오 대학', '동방 스타', '항사이 B', '경찰 B', '알리안사 B', '마카오 유니온', '마카오 유스', '디스포르티바 마카오'])},
    '쿡 제도': {1: ('쿡 제도 라운드 컵', ['투파파 마라에렝가', '니카오 소카탁', '푸아이쿠라 FC', '아티우 FC', '마타베라 FC', '티티카베카 FC', '아바투아 유나이티드', '타쿠바이니 FC']), 2: ('쿡 제도 퍼스트 디비전', ['아바루아 소커', '아로랑이 FC', '투파파 B', '니카오 B', '푸아이쿠라 B', '마타베라 B', '티티카베카 B', '아티우 B']), 3: ('쿡 제도 세컨드 디비전', ['라로통가 FC', '아이투타키 FC', '망가이아 FC', '투파파 스타', '니카오 스타', '푸아이쿠라 스타', '쿡 제도 유니온', '라인데이비 FC'])},
    '미국령 사모아': {1: ('FFAS 시니어 리그', ['파고 유스', '우투레이 유스', '바이알라 통가', '릴라 FC', '타푸나 제츠', '블랙 로즈 FC', '그린 베이 FC', '일라오아 앤 투아마아라']), 2: ('FFAS 퍼스트 디비전', ['파고 스타즈', '우투레이 스타', '릴라 B', '타푸나 B', '파고 유스 B', '바이알라 B', '블랙로즈 B', '그린베이 B']), 3: ('FFAS 세컨드 디비전', ['사모아 유나이티드', '투투일라 FC', '아누우 스타즈', '파고 킹스', '제츠 B', '통가 B', '릴라 스타', '미국령 사모아 유니온'])}
}
...
NAME_DATA = {
    '보스니아 헤르체고비나': ['제코', '데미로비치', '타히로비치', '하이라디노비치', '피아니치', '크루니치', '치미로트', '코바체비치', '라흐마노비치', '바시치', '콜라시나츠', '아메드호지치', '데디치', '가지베고비치', '바리시치', '하치카두니치', '세히치', '바실', '피리치', '시비치', '타바코비치', '프레블랴크', '스테바노비치', '고야크', '치비치', '사니차닌', '밀리체비치', '하치아흐메토비치', '줄키치', '비샤'],
    ...
    '튀르키예': ['하칸', '아르다', '케난', '바르투', '메리흐', '찰라르', '페르디', '우구르잔', '찰하놀루', '귀렐', '이을디즈', '일마즈', '데미랄', '쇠윈쥐', '카디오글루', '차키르', '토순', '야즈즈', '카흐베치', '악튀르코글루', '코크추', '외잔', '아야한', '바르닥치', '카바크', '첼리크', '뮬뒤르', '귀노크', '바인디르', '킬리치소이'],
    ...
    '북한': ['정일관', '한광성', '최주성', '리형진', '김국범', '장국철', '강주혁', '신태성', '박광룡', '리은철', '백충성', '문인주', '김유성', '안병준', '박현일', '명차현', '최옥철', '리영직', '김경훈', '조광명', '안대성', '리명국'],
    ...
    '콩고 민주 공화국': ['음벰바', '위사', '봉공다', '바캄부', '엘리아', '무투사미', '피켈', '카유베', '아투아나', '마수아쿠', '바투빈시카', '이노코', '칼룰루', '바야예', '음파시', '베르토', '시아디', '마율라', '카송고', '디앙가나', '실라스', '카옘베', '무카우', '은디아예', '음풀루', '부샤투', '망갈라', '카방구', '조나단', '바나자'],
    '부르키나 파소': ['탑소바', '트라오레', '와타라', '코나테', '방데', '투레', '기라', '상가레', '사바도고', '카보레', '데이오', '나갈로', '야고', '귀에브레', '코피', '코나페', '니키에마', '사누', '방방간', '지브릴', '라시나', '이스마엘', '살루', '바이라', '티에드레', '우에드라오고', '쿨리발리', '바니', '조나단', '아지즈'],
    '모잠비크': ['카타모', '레이티', '바우케', '구이마', '아마데', '캄푸스', '위치', '네네', '샤킬', '도밍구스', '멕세르', '레이날도', '도브', '만다바', '라티포', '말랑가나', '에르나니', '우루발', '파지토', '킹', '치키뉴', '제랄도', '체릴', '루이스', '닐톤', '지니', '텔로', '에드밀손', '발로이', '카르발류'],
    '적도 기니': ['엔수에', '미란다', '가네트', '마친', '살바도르', '음부라', '시아파', '오비앙', '발보아', '오노', '코코', '아카포', '아니에보', '은동', '세나', '음바', '오보노', '삽', '엠벨라', '에네메', '부일라', '오스카', '하비에르', '바실리오', '미구엘', '네스토르', '도리안', '루이스', '크리스티안', '호세'],
    '코모로': ['유스프', '셀레마니', '나부한', '마올리다', '음창가마', '부르한', '바카리', '음다호마', '자하리', '압달라', '음라다바니', '벤', '보이나', '아하마다', '판디', '사이드', '다우', '유수프', '카심', '이보이', '마트투아', '하마디', '샤메드', '바카르', '모하메드', '알리', '파이즈', '아흐메드', '나짐', '술레'],
    '리비아': ['알 무스라티', '살라마', '엘후니', '사부', '타주리', '함두', '알리', '샤라디', '가디디', '엘문시르', '와르팔리', '투지', '샤레프', '알라피', '알 타르후니', '막시', '줄피', '쿠자', '벤 알리', '나슈누시', '에즈와', '탈리', '자이드', '바드라', '하마드', '가리브', '메즈기시', '사이드', '칼리파', '오마르'],
    '탄자니아': ['사마타', '음수바', '음카미', '요하나', '아브라함', '마오', '응고다', '카부일레', '므와무뇨토', '므와냐미카', '조브', '디스마스', '바카리', '키부', '야신', '사룰라', '마눌라', '카케냐', '살룸', '후세인', '므와센다', '키팡가', '모하메드', '음사이', '알리', '주마', '하미스', '므위니', '사이디', '냐오니'],
    '니제르': ['무사', '아데바요르', '워투바', '소우마나', '모하메드', '본카노', '우마루', '알리', '가르바', '카투코레', '라이에', '사코', '아미두', '마하마두', '지보', '할리두', '사니', '마이누', '살리푸', '자우라', '탄자', '우세이니', '이브라힘', '불라', '하마니', '압둘라', '카밀루', '알하산', '우마르', '다우다'],
    '감비아': ['배로우', '콜리', '얀코', '아담스', '치에', '시세이', '마레', '바보', '소우', '자부', '바지', '고메즈', '사네', '투레이', '멘디', '가야', '자이네', '은지', '음뵤', '조베', '게예', '함자', '이브라힘', '알리', '무스타파', '오스만', '라마단', '파티', '세이디', '디안카'],
    '수단': ['압델라만', '바키트', '테리', '엘 타헤르', '카말', '아구브', '샤르펠딘', '마흐주브', '엘 사비', '알리', '아부에스린', '무스타파', '알라가', '아담', '모하메드', '하산', '오마르', '사이드', '함자', '야시르', '발라', '누르', '압둘', '살라', '에삼', '자카리아', '칼리드', '아흐메드', '이사', '이드리스'],
    '토고': ['베부', '데네키', '로마오', '플라카', '악포비', '아호에수', '클루세', '추이', '우로가그나', '드제네', '아가보', '아미누', '베시', '헤르세', '브라시', '바리콜라', '우로', '차케이', '에녹', '사마', '이자크', '모하메드', '야쿠부', '알렉시스', '나르시스', '카림', '압둘', '살리푸', '조나단', '길베르트'],
    '시에라리온': ['카마라', '코로마', '부아', '카이카이', '윌리엄스', '모모', '칸테', '카르보', '포파나', '스트라세르', '던부야', '카크사이', '사마', '세사이', '방구라', '타라왈리', '덤부야', '투레이', '존스', '배로우', '줄리어스', '알하지', '케이', '술레이만', '콜리', '모하메드', '알리', '자칼리아', '무사', '이샤크'],
    '르완다': ['하키지마나', '은슌티', '카가레', '비지마나', '무하지리', '무기샤', '니용지마', '무쿠냐', '마니지마나', '니리링기마나', '옴보렝가', '이만니시무에', '루와부히히', '무투시', '킴엔이', '콰이제라', '은자바니', '이노센트', '앙주', '에릭', '파트리크', '올리비에', '야닉', '보스코', '장', '클로드', '피에르', '디디에', '블레이즈', '파브리스'],
    '짐바브웨': ['카데웨레', '문데츠', '나캄바', '무소나', '빌리엇', '흘롱와네', '둔쿠', '마두브', '하데베', '치와웅가', '무디무', '로링', '펠레', '치페제제', '마포사', '마팜바', '마토포', '무티자', '카루루', '치와와', '시반다', '찰스', '알렉스', '도날드', '쿠다콰셰', '가르시아', '기븐', '태런트', '조지', '워싱턴'],
    '콩고 공화국': ['간불라', '비푸마', '은딩가', '마칸다', '마사바', '음벰바', '음부시', '이바라', '치방구', '추이', '마욤벨라', '은고마', '이투아', '바두', '포앙바', '마푸타', '파시', '은디아예', '음방가', '바카', '마투시와', '실라스', '프린스', '크리스', '브리앙', '장', '딜런', '요안', '케빈', '가이'],
    '중앙아프리카공화국': ['콘도그비아', '마푸타', '윰비', '은가마', '양가오', '나마시', '유가', '자호', '그레구아르', '은도베', '과리', '코토', '바나', '기아망이', '렘베티', '사마라', '바바우', '양가', '토고', '방구라', '쿨리발리', '디아라', '포파나', '아흐메드', '무사', '카림', '알리', '모하메드', '이브라힘', '하산'],
    '라이베리아': ['유엔', '카마라', '샤르망', '도르레이', '냐네', '메콜리', '티뇨', '수마오로', '매콜리', '산호', '존슨', '스미스', '자라', '도에', '웨아', '윌리엄스', '투레이', '타르페', '코르포', '케네', '깁슨', '콜리', '테이', '데니스', '블라', '알리', '케빈', '마크', '앤드류', '토마스'],
    '부룬디': ['베라히노', '아미시', '은시미리마나', '은디쿠마나', '비지마나', '콰이제라', '은샤비윰바', '무스타파', '압둘', '라자크', '은두와루기라', '니온쿠루', '무카라', '은세구윰바', '루카마', '나히마나', '나하요', '은다이시미예', '은자비예', '부루디', '클로드', '장', '피에르', '에릭', '파브리스', '야닉', '조나단', '알리', '모하메드', '하산'],
    '에티오피아': ['나세르', '호테사', '게브레미카엘', '다와', '베케레', '파놈', '요하네스', '솔로몬', '메코넨', '다그나체우', '타메네', '두쿠', '툰조', '투라', '함자', '레샤드', '슈메트', '톤조', '알리', '하산', '모하메드', '아흐메드', '이브라힘', '오마르', '세이드', '가토치', '요셉', '아사찰류', '게타네', '피크루'],
    '레소토': ['모틀레방', '모카흘라네', '베렝', '세라', '포토', '타바네', '말라네', '마케페', '츠와네', '모에라네', '네오', '코틀레', '초스', '코에틀레', '레흘로호놀로', '체포', '탈리', '모하피', '세틀룸부', '응카우', '마세루', '레리베', '모할레', '캄포', '마틀라마', '반투', '리올리', '루카스', '존', '윌리엄스'],
    '보츠와나': ['시가니에', '오레본예', '쿠퍼', '딧흘로콰이', '가올라올웨', '벨라피', '타타야오네', '존슨', '모가오르시', '람틀라하와네', '나토', '마포사', '티리', '니알레', '치코', '탈레', '음바디', '세가콜로', '세로', '포고', '음포', '네오', '타보', '레세디', '카벨로', '모틀하방', '마틀호코', '모가티', '가보로네', '롤러즈'],
    '에스와티니': ['은디지니', '마바', '스왈로즈', '음카바', '레오파드', '맘바', '가메제', '드라미니', '엔카부카', '티자메니', '마가굴라', '마세코', '마체술라', '은캄불레', '마틀라방', '치코', '티모시', '피터', '폴', '토마스', '조지', '윌리엄스', '앤드류', '데이비드', '제임스', '존', '로버트', '마이클', '찰스', '리차드'],
    '모리셔스': ['비니', '랭베르', '브루', '장', '루이', '콜린', '발라르', '나지라', '페레', '페라리', '라스카르', '조프레', '로즈', '오귀스탱', '샤를', '아르디', '카시', '다비드', '기욤', '알렉스', '앙투안', '마티유', '로랭', '조나단', '장뤽', '케빈', '크리스토프', '올리비에', '파브리스', '야닉'],
    '차드': ['닝가', '은두아셀', '자히르', '마하마트', '나도니', '압둘라', '진', '음바이에', '토고', '은가람', '디지아', '알리', '카림', '모하메드', '아흐메드', '이브라힘', '하산', '오마르', '사이드', '이드리스', '자카리아', '유수프', '무사', '술레이만', '바카르', '카밀', '우마르', '아바카르', '야쿠브', '우세이니'],
    '상투메 프린시페': ['루이스', '실바', '네베스', '바레토', '소우자', '산토스', '카르도소', '비에가스', '엔리케', '멘데스', '과달루페', '알리앙사', 'UDRA', '프라야', '조제', '마누엘', '안토니오', '페드로', '카를로스', '페르난도', '주앙', '프란시스코', '미구엘', '히카르두', '브루누', '티아구', '디오구', '누누', '바스코', '알렉상드르'],
    '트리니다드 토바고': ['가르시아', '존스', '몰리노', '가르시아', '포춘', '해크쇼', '필립', '길', '무어', '코빈', '바토', '고든', '데이비드', '초우', '레이몬드', '스미스', '프레우스', '윌리엄스', '하스켈', '제임스', '스튜어트', '프랜시스', '램버트', '닐', '로버츠', '그린', '토마스', '폴', '찰스', '알렉산더'],
    '앤티가 바부다': ['디에투알', '호퍼스', '필립', '토마스', '그리피스', '헨리', '벤자민', '존', '조셉', '윌리엄스', '샘플', '스티븐스', '피터스', '보우먼', '로빈슨', '찰스', '리차드', '제임스', '다니엘', '새뮤얼', '조지', '마이클', '앤드류', '데이비드', '로버트', '윌리엄', '크리스토퍼', '매튜', '조슈아', '안소니'],
    '몬트세라트': ['테일러', '헤이우드', '위크', '아치볼드', '윌리엄스', '존', '로버츠', '포스터', '컴버배치', '스미스', '브라운', '그린', '토마스', '화이트', '제임스', '찰스', '리차드', '조지', '마이클', '앤드류', '데이비드', '로버트', '윌리엄', '크리스토퍼', '매튜', '조슈아', '해리스', '루이스', '다니엘', '새뮤얼'],
    '벨리즈': ['로페스', '매콜리', '살라사르', '스미스', '베르나르데스', '게라', '앤더슨', '트랩', '로치즈', '메사', '풀레', '케이시', '마이아', '튜닉', '말도나도', '존스', '데이비스', '토마스', '밀러', '제임스', '찰스', '리차드', '조지', '마이클', '앤드류', '데이비드', '로버트', '윌리엄', '크리스토퍼', '매튜'],
    '앵귈라': ['로저스', '가이즈', '휴스', '파리스', '스미스', '토마스', '윌리엄스', '존', '로버츠', '브라운', '그린', '리차드', '제임스', '찰스', '조지', '마이클', '앤드류', '데이비드', '로버트', '윌리엄', '크리스토퍼', '매튜', '조슈아', '해리스', '루이스', '다니엘', '새뮤얼', '알렉산더', '프랭크', '헨리'],
    '캄보디아': ['찬바타나카', '바타나카', '속펭', '우도돈', '분헤잉', '크리야', '샹테아', '피사', '티바', '소하', '비스나', '멘도사', '수하나', '참루엔', '폴로스', '쏙삼올', '속남', '치엔', '림', '속하', '찬', '티티', '다니', '보레이', '라보라비', '삼엔', '소반', '로타', '체아', '소완네아트'],
    '네팔': ['키란', '비스타', '슈레스타', '타파', '라마', '카르키', '하와스', '라인자히', '라야마지', '구룽', '카프리', '타망', '바스넷', '단기', '파탄', '간다르바', '네팔', '수베디', '포카렐', '아디카리', '디시', '부델', '마하르잔', '마가르', '기리', '레그미', '조시', '데브코타', '판데이', '카날'],
    '방글라데시': ['부얀', '라나', '자니', '이브라힘', '파호드', '고쉬', '라만', '하산', '미아', '카잔', '아흐메드', '무르살린', '리돈', '소헬', '라나', '키스토', '우딘', '바르만', '카지', '사브주', '이스람', '알리', '모하메드', '수잔', '자말', '티푸', '아리프', '야신', '나짐', '메헤디'],
    '라오스': ['부운콩', '케오하남', '실리판야', '와나손', '공마틸라트', '인타봉', '펫비라반', '참파통', '비엔헤라', '시파송', '수가봉', '시사바트', '소파사트', '통사반', '루앙라트', '볼라사트', '남보나', '시티디', '분타봉', '솜사니트', '찬타봉', '펫사모네', '통파트', '비엔세이', '파사트', '마노이', '참파', '분미', '찬타', '솜분'],
    '마카오': ['니키 토랑', '렁카항', '팡치항', '찬만호', '공치하오', '람카셍', '호이카싱', '체옹치인', '토랑', '필리페', '조제', '카를로스', '루이스', '찬친호', '라오치만', '응와이치', '렁치치', '초이만인', '레이카힘', '이옹치호', '웡와이홍', '호이카와이', '람카와이', '체앙치호', '막카호', '삼카이치', '라오치호', '탕호인', '콴치와이', '푼치에옹'],
    '쿡 제도': ['티아레', '소카', '마라에', '니카오', '아티우', '마타베라', '티티카베카', '아바투아', '푸아이쿠라', '존슨', '스미스', '찰스', '리차드', '제임스', '조지', '마이클', '앤드류', '데이비드', '로버트', '윌리엄', '크리스토퍼', '매튜', '조슈아', '해리스', '루이스', '다니엘', '새뮤얼', '존', '윌리엄스', '톰'],
    '미국령 사모아': ['파고', '우투레이', '바이알라', '릴라', '타푸나', '사모아', '투투일라', '아누우', '존슨', '스미스', '찰스', '리차드', '제임스', '조지', '마이클', '앤드류', '데이비드', '로버트', '윌리엄', '크리스토퍼', '매튜', '조슈아', '해리스', '루이스', '다니엘', '새뮤얼', '존', '윌리엄스', '피터', '폴']
}

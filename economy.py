...
def _salary_cap_table():
    ...
    return {
        ...
        # [2026-08 재조정, 신민용 제공 실측 데이터 반영] D/E 등급 천장이
        # 각각 5,000만원/2,000만원으로 너무 낮아서, 이번에 반영한 신규
        # 데이터의 D/E급 국가 중 목표 평균연봉이 이 천장보다 높은 나라들
        # (예: 북아일랜드/볼리비아/오만 7,000만원, 리투아니아 5,000만원)이
        # 전부 이 등급 천장에 눌려 있었다. 최댓값 기준으로 여유 있게 상향.
        # [2026-08 재조정, 신민용 제공 실측 데이터 반영] D등급 천장을 tier2/3
        # 목표치(북아일랜드 tier3 2,000만원 등)까지 커버하도록 재상향.
        "C": 450_000, "D": 150_000, "E": 60_000, "F": 10_000,
    }

...
# 노화 (나이 → 연간 한계스탯 감소). 30세부터 현실적으로 쇠퇴 시작.
#   본격 하락은 33세 이후, 37세 이후 급격.
#   ※ 실제 적용량은 아래 AGING_TIER_MULT(재능 등급별 배수)로 차등화된다.
AGING = [(30,1),(33,3),(35,4),(37,6),(39,7)]
...
AGING_FLOOR_RATIO = {
    "worldclass": 0.88,   # 전성기의 88%까지만 하락 (예: 96 → 최저 ~85)
    "elite":      0.82,
    "normal":     0.74,
    "limited":    0.62,   # 깊게 하락 (예: 78 → 최저 ~48)
}

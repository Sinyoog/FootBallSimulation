...
# - ucl_champion: 챔스 우승 직후 다음 시즌에도 강팀일 가능성을 높여주되,
#   강등 쿠션보다는 약하고 짧게 — 우승 자체가 이미 강함의 증거이므로
#   여기에 또 큰 보너스를 얹으면 "챔스 우승 → 장기 왕조"가 되어버린다.
#   (준우승/4강/유로파/컨퍼런스 등 다른 국제대회 성적 등급은 추후 확장.)
MOMENTUM_SCHEDULES = {
    "relegation_recovery": {4: (1.00, 1.5), 3: (0.85, 1.0), 2: (0.70, 0.5), 1: (0.55, 0.25)},
